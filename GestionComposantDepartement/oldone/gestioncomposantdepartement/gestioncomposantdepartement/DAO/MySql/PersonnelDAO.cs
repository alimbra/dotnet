...
namespace gestioncomposantdepartement.DAO.MySql
{
    public class PersonnelDAO:DAO
    {
        ...
        public const int ID_CATEGORIE = 5;
        public const int NOM_CATEGORIE = 6;
        public const int NB_HEURES_CATEGORIE = 7;

        public const int ID_DEPARTEMENT = 8;
        public const int NOM_DEPARTEMENT = 9;
        ...
        public void create(Personnel personnel)
        {
            try
            {
                ...
                commande.CommandText = @"INSERT INTO projetgestiondepartement.Personnel (prenom , nom, categorie_id, departement_id)  VALUES  (@prenom , @nom, @categorie_id, @departement_id);";
                ...
                if(personnel.DepartementPropriete != null) commande.Parameters.AddWithValue("@departement_id", personnel.DepartementPropriete.id);
                else commande.Parameters.AddWithValue("@departement_id", null);
        ...
        public void update(Personnel personnel,int categorieId)
        {
            try
            {
                ...
                SET prenom = @prenom, nom = @nom, categorie_id = @categorie_id,departement_id = NULL
